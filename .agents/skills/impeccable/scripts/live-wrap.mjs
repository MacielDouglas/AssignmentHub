...
The agent should insert variant HTML at insertLine.`);
	...
	const componentPreviewMode = useSvelteComponent
		? "svelte-component"
		: undefined;
	...
	console.log(
		JSON.stringify({
			...
			cssSelectorPrefixExamples: useFrameworkComponent
				? []
...
function _attrEscapeDouble(str) {
	return String(str)
		.replace(/&/g, "&amp;")
		.replace(/"/g, "&quot;")
		.replace(/</g, "&lt;")
