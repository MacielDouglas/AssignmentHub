	...
	return (
		<div className="space-y-4">
					...
					{lists.map((l) => {
						...
						return (
							<button
								...
								className={`min-w-35 shrink-0 rounded-2xl border border-border px-3 py-2 text-left text-xs ${
			...
			{myAssignments.length > 0 ? (
				<section className="rounded-3xl border border-muted bg-muted p-4 print:hidden">
			...
			{confirmDelete && canManage ? (
				...
				>
					<p
						...
						className="text-title text-red-900 dark:text-red-100"
					>
